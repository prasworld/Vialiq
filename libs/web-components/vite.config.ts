  ...
  build: {
    ...
    lib: {
      entry: {
        ...
        'tabs/vi-tabs': path.resolve(__dirname, 'src/tabs/vi-tabs.ts'),
        'tabs/vi-tab': path.resolve(__dirname, 'src/tabs/vi-tab.ts'),
        'tabs/vi-tab-panel': path.resolve(__dirname, 'src/tabs/vi-tab-panel.ts'),
        'tabs/index': path.resolve(__dirname, 'src/tabs/index.ts'),
        'spin/vi-spin': path.resolve(__dirname, 'src/spin/vi-spin.ts'),
        'spin/index': path.resolve(__dirname, 'src/spin/index.ts'),
        'card/vi-card': path.resolve(__dirname, 'src/card/vi-card.ts'),
        'card/index': path.resolve(__dirname, 'src/card/index.ts'),
        'skeleton/vi-skeleton': path.resolve(__dirname, 'src/skeleton/vi-skeleton.ts'),
        'skeleton/index': path.resolve(__dirname, 'src/skeleton/index.ts'),
