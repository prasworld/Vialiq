 ...
 */
export const EXIT_COUNTERPART: Partial<Record<string, string>> = {
  'fade-in': 'fade-out',
 ...
 */
export const PRESET_KEYFRAMES: Record<string, Keyframe[]> = {
...
export const EXPAND_COLLAPSE_PRESETS = new Set([
  'expand-vertical',
  'collapse-vertical',
  'expand-horizontal',
  'collapse-horizontal',
