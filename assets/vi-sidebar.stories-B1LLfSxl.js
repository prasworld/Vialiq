  ...
  `;
            ...
            updated(changedProperties) {
                ...
                if (changedProperties.has('opened')) {
                    ...
                    this.dispatchEvent(new CustomEvent('vi-opened-change', {
                        detail: {
                            opened: this.opened
                        },
                        bubbles: true,
    ...
    `;
            ...
            /** Opens the sidebar. */ open() {
                if (!this.opened) {
                    this.dispatchEvent(new CustomEvent('vi-open-start', {
                        bubbles: true,
                        composed: true
                    }));
                    this.opened = true;
            ...
            /** Closes the sidebar. */ close() {
                if (this.opened) {
                    this.dispatchEvent(new CustomEvent('vi-close-start', {
                        bubbles: true,
                        composed: true
                    }));
                    this.opened = false;
            ...
            _onTransitionEnd = (e)=>{
                ...
                if (e.target === this && (e.propertyName === 'transform' || e.propertyName === 'width' || e.propertyName === 'height')) {
                    this.dispatchEvent(new CustomEvent('vi-transition-end', {
                        bubbles: true,
                        composed: true
                    }));
                    if (this.opened) {
                        this.dispatchEvent(new CustomEvent('vi-after-opened', {
                            bubbles: true,
                            composed: true
                        }));
                    } else {
                        this.dispatchEvent(new CustomEvent('vi-after-closed', {
                            bubbles: true,
                            composed: true
                        }));
                    }
...
new class extends _identity {
  ...
  `;
    ...
    `;
            ...
            _onBackdropClick() {
                this.dispatchEvent(new CustomEvent('vi-backdrop-click', {
                    bubbles: true,
                    composed: true
                }));
                this._sidebars.forEach((sidebar)=>{
