import { c as i, r as r$1, i as i$1, b } from './iframe-Cf8MuM-X.js';
import { o as o$1 } from './if-defined-vnRm5S2X.js';
import { t, n } from './vi-element-BEC28UpK.js';
import { r } from './state-C9uV9lvM.js';
import { e } from './class-map-CG0Gh4Yz.js';
import { o } from './style-map-DLkcNf1U.js';
import './vi-alert-CEWDRF2i.js';
...
import './check-circle-BQwul-8G.js';
import './triangle-warning-CA6nkDfn.js';
...
new class extends _identity {
    ...
    static{
        class ViSpin extends (_LitElement = i) {
            static{
  ...
  `;
        ...
        `;
                    ...
                    return b`
        <svg viewBox="0 0 24 24" class=${e(svgClasses)} xmlns="http://www.w3.org/2000/svg">
      ...
      `;
          ...
          <div class=${e(spinWrapperClasses)} part="wrapper">
            <slot name="indicator">
              ${renderIndicator()}
            </slot>
        ...
        <div class="spin-nested-loading" part="nested">
          ${spinElement}
          <div class=${e(containerClasses)} part="container">
            <slot></slot>
          </div>
        </div>
      `;
