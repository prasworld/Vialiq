import { r as r$2, i, b, a as r$3, M, u as u$1, v, h as h$1, E, p, c as i$2, A } from './iframe-DnETEnWs.js';
import { V as ViElement, t, n as n$1 } from './vi-element-BZnLtp_v.js';
import { r as r$1 } from './state-gKBTU9MN.js';
...
import { c as chevronDownIcon, m as minusIcon } from './minus-CxLQocyA.js';
import { x as xIcon } from './x-3JmBhc9n.js';
import './base-Cl6v8-BZ.js';

const itemStyles = "@charset \"UTF-8\";@layer reset,components,utilities;@layer components{.combobox-field{display:flex;flex-direction:column;gap:var(--vi-combobox-spacing-field-gap, var(--vi-spacing-xs, 8px));width:100%;position:relative}.combobox-control{display:flex;align-items:center;flex-wrap:wrap;gap:var(--vi-combobox-tag-gap, var(--vi-spacing-xs, 8px));box-sizing:border-box;width:100%;min-height:var(--vi-combobox-min-height, 40px);padding:var(--vi-combobox-padding-block, var(--vi-spacing-xs, 8px)) var(--vi-combobox-padding-inline, var(--vi-spacing-sm, 16px));background-color:var(--vi-combobox-background, var(--vi-color-background, #ffffff));border:var(--vi-combobox-border-width, var(--vi-border-width-thin, 1px)) solid var(--vi-combobox-border-color, var(--vi-border-03, #e0e0e0));border-radius:var(--vi-combobox-border-radius, var(--vi-border-radius-lg, 8px));font-family:var(--vi-font-family-base, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif);font-size:var(--vi-combobox-font-size, var(--vi-font-size-base, 16px));color:var(--vi-combobox-text-color, var(--vi-text-primary, #111827));transition:border-color .15s ease,box-shadow .15s ease;cursor:text;position:relative}.combobox-control:hover:not(.is-disabled):not(.is-focused){border-color:var(--vi-combobox-border-color-hover, var(--vi-border-04, #bdbdbd))}.combobox-control.is-focused,.combobox-control:focus-within{border-color:var(--vi-combobox-border-color-focus, var(--vi-focus, #3676d0));outline:var(--vi-combobox-border-width-focus, var(--vi-border-width-base, 2px)) solid var(--vi-combobox-focus-ring-color, var(--vi-focus, #3676d0));outline-offset:0;box-shadow:0 0 0 3px var(--vi-combobox-focus-ring-glow, var(--vi-color-blue-200, #cee6ff))}.combobox-control.is-disabled{opacity:var(--vi-combobox-disabled-opacity, .6);pointer-events:none;cursor:not-allowed}.combobox-control.is-invalid{border-color:var(--vi-combobox-error-color, var(--vi-color-error, #ef4444))}.combobox-control.is-invalid.is-focused,.combobox-control.is-invalid:focus-within{outline-color:var(--vi-combobox-error-color, var(--vi-color-error, #ef4444))}.combobox-control.is-valid{border-color:var(--vi-combobox-success-color, var(--vi-color-success, #489167))}.combobox-input{appearance:none;-webkit-appearance:none;flex:1 1 60px;min-width:60px;border:none;outline:none;background:transparent;padding:0;margin:0;font-family:inherit;font-size:inherit;color:inherit;line-height:var(--vi-line-height-normal, 1.5)}.combobox-input::placeholder{color:var(--vi-combobox-placeholder-color, var(--vi-text-secondary, #4b5563))}.combobox-chevron{margin-left:auto;color:var(--vi-combobox-chevron-color, var(--vi-text-secondary, #4b5563));flex-shrink:0;transition:transform .2s cubic-bezier(.2,0,0,1);transform-origin:center center;pointer-events:auto;cursor:pointer;width:18px;height:18px}.combobox-control.is-open .combobox-chevron{transform:rotate(180deg)}.combobox-clear-btn{appearance:none;-webkit-appearance:none;background:transparent;border:none;padding:2px;margin:0;display:inline-flex;align-items:center;justify-content:center;color:var(--vi-combobox-clear-color, var(--vi-text-secondary, #4b5563));cursor:pointer;border-radius:var(--vi-border-radius-sm, 2px);transition:color .15s ease,background-color .15s ease;width:20px;height:20px;flex-shrink:0}.combobox-clear-btn:hover{color:var(--vi-combobox-clear-hover-color, var(--vi-text-primary, #111827));background-color:var(--vi-combobox-clear-hover-bg, var(--vi-layer-hover-01, #f3f4f6))}.combobox-trigger{appearance:none;-webkit-appearance:none;flex:1 1 0px;min-width:0;display:inline-flex;align-items:center;border:none;outline:none;background:transparent;padding:0;margin:0;font-family:inherit;font-size:inherit;color:inherit;line-height:inherit;text-align:left;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;cursor:pointer}.combobox-trigger.is-placeholder{color:var(--vi-combobox-placeholder-color, var(--vi-text-secondary, #4b5563))}.combobox-tags{display:flex;flex-wrap:wrap;align-items:center;gap:var(--vi-combobox-tag-gap, var(--vi-spacing-xs, 8px))}.combobox-listbox{box-sizing:border-box;position:absolute;top:0;left:0;z-index:var(--vi-combobox-listbox-z-index, 1000);height:var(--vi-combobox-listbox-height, auto);max-height:var(--vi-combobox-listbox-max-height, 280px);overflow-y:auto;background-color:var(--vi-combobox-listbox-background, var(--vi-layer-01, #ffffff));border:1px solid var(--vi-combobox-listbox-border-color, var(--vi-border-02, #eeeeee));border-radius:var(--vi-combobox-listbox-border-radius, var(--vi-border-radius-lg, 8px));box-shadow:var(--vi-combobox-listbox-shadow, var(--vi-shadow-md, 0 4px 6px -1px rgba(0, 0, 0, .1)));padding:4px 0;margin:0;opacity:0;visibility:hidden;transform:translateY(-6px) scale(.98);transform-origin:top center;transition:opacity .16s cubic-bezier(.2,0,0,1),transform .16s cubic-bezier(.2,0,0,1),visibility .16s cubic-bezier(.2,0,0,1);pointer-events:none}.combobox-listbox[data-placement^=top]{transform-origin:bottom center;transform:translateY(6px) scale(.98)}.combobox-listbox[open],.combobox-listbox.is-open{opacity:1;visibility:visible;transform:translateY(0) scale(1);pointer-events:auto}.combobox-list{list-style:none;margin:0;padding:0}.combobox-option{display:flex;align-items:center;justify-content:space-between;gap:var(--vi-combobox-option-gap, var(--vi-spacing-xs, 8px));min-height:var(--vi-combobox-option-height, 40px);padding:var(--vi-combobox-option-padding-block, var(--vi-spacing-xs, 8px)) var(--vi-combobox-option-padding-inline, var(--vi-spacing-sm, 16px));font-size:var(--vi-combobox-option-font-size, var(--vi-font-size-base, 16px));color:var(--vi-combobox-option-color, var(--vi-text-primary, #111827));cursor:pointer;-webkit-user-select:none;user-select:none}.combobox-option:hover,.combobox-option.is-active{background-color:var(--vi-combobox-option-hover-bg, var(--vi-layer-hover-01, #f3f4f6))}.combobox-option.is-selected{background-color:var(--vi-combobox-option-selected-bg, var(--vi-layer-02, #f3f4f6));color:var(--vi-combobox-option-selected-color, var(--vi-color-primary, #3676d0));font-weight:var(--vi-font-weight-semibold, 600)}.combobox-option.is-disabled{color:var(--vi-combobox-option-disabled-color, var(--vi-text-disabled, #9e9e9e));cursor:not-allowed;pointer-events:none;opacity:.6}.combobox-option-content{display:flex;flex-direction:column;flex:1 1 auto;overflow:hidden}.combobox-option-label{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.combobox-option-description{font-size:var(--vi-combobox-option-description-font-size, var(--vi-font-size-sm, 14px));color:var(--vi-combobox-option-description-color, var(--vi-text-secondary, #4b5563));white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.combobox-option-action{display:flex;align-items:center;margin-left:auto;z-index:1}.combobox-mark{background-color:var(--vi-combobox-mark-background, var(--vi-bg-warning, #fff8e1));color:var(--vi-combobox-mark-color, var(--vi-text-primary, #111827));border-radius:var(--vi-border-radius-sm, 2px);padding:0 1px}.combobox-group-header{padding:8px var(--vi-combobox-group-padding-inline, var(--vi-spacing-sm, 16px)) 4px;font-size:var(--vi-combobox-group-font-size, var(--vi-font-size-xs, 12px));font-weight:var(--vi-combobox-group-font-weight, var(--vi-font-weight-semibold, 600));color:var(--vi-combobox-group-color, var(--vi-text-secondary, #4b5563));text-transform:uppercase;letter-spacing:var(--vi-letter-spacing-wide, .025em);-webkit-user-select:none;user-select:none}.combobox-empty,.combobox-loading{padding:var(--vi-spacing-sm, 16px);text-align:center;font-size:var(--vi-font-size-sm, 14px);color:var(--vi-text-secondary, #4b5563)}.combobox-helper{font-size:var(--vi-combobox-validation-font-size, var(--vi-font-size-xs, 12px));color:var(--vi-combobox-helper-color, var(--vi-text-helper, #9e9e9e))}.combobox-validation{font-size:var(--vi-combobox-validation-font-size, var(--vi-font-size-xs, 12px));color:var(--vi-combobox-error-color, var(--vi-color-error, #ef4444))}.combobox-validation.is-valid{color:var(--vi-combobox-success-color, var(--vi-color-success, #489167))}@media(prefers-reduced-motion:reduce){.combobox-control,.combobox-option{transition:none}}}:host{display:block}:host([hidden]){display:none!important}";
...
var _dec$1, _initClass$1, _ViElement, _dec1$1, _dec2$1, _dec3$1, _dec4$1, _dec5$1, _dec6$1, _dec7$1, _dec8$1, _dec9$1, _dec10$1, _dec11$1, _init_value$1, _init_label, _init_data, _init_group, _init_disabled$1, _init_icon, _init_description, /**
   ...
   */ _init_searchText, _init_selected, _init_active, _init__hasSlotContent, _initProto$1;
registerIcons([
    checkIcon
]);
let _ViComboboxItem;
...
new class extends _identity$1 {
    ...
    static{
        class ViComboboxItem extends (_ViElement = ViElement) {
            static{
                ({ e: [_init_value$1, _init_label, _init_data, _init_group, _init_disabled$1, _init_icon, _init_description, _init_searchText, _init_selected, _init_active, _init__hasSlotContent, _initProto$1], c: [_ViComboboxItem, _initClass$1] } = _apply_decs_2203_r$1(this, [
                    [
                        _dec1$1,
                        1,
                        "value"
  ...
  `;
            ...
            #___private__hasSlotContent_11 = _init__hasSlotContent(this, false);
            get _hasSlotContent() {
                return this.#___private__hasSlotContent_11;
            }
            set _hasSlotContent(_v) {
                this.#___private__hasSlotContent_11 = _v;
            }
            connectedCallback() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const u=(e,s,t)=>{const r=new Map;for(let l=s;l<=t;l++)r.set(e[l],l);return r},c=e(class extends i$1{constructor(e){if(super(e),e.type!==t$1.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,s,t){let r;void 0===t?t=s:void 0!==s&&(r=s);const l=[],o=[];let i=0;for(const s of e)l[i]=r?r(s,i):i,o[i]=t(s,i),i++;return {values:o,keys:l}}render(e,s,t){return this.dt(e,s,t).values}update(s,[t,r,c]){const d=M(s),{values:p$1,keys:a}=this.dt(t,r,c);if(!Array.isArray(d))return this.ut=a,p$1;const h=this.ut??=[],v$1=[];let m,y,x=0,j=d.length-1,k=0,w=p$1.length-1;for(;x<=j&&k<=w;)if(null===d[x])x++;else if(null===d[j])j--;else if(h[x]===a[k])v$1[k]=u$1(d[x],p$1[k]),x++,k++;else if(h[j]===a[w])v$1[w]=u$1(d[j],p$1[w]),j--,w--;else if(h[x]===a[w])v$1[w]=u$1(d[x],p$1[w]),v(s,v$1[w+1],d[x]),x++,w--;else if(h[j]===a[k])v$1[k]=u$1(d[j],p$1[k]),v(s,d[x],d[j]),j--,k++;else if(void 0===m&&(m=u(a,k,w),y=u(h,x,j)),m.has(h[x]))if(m.has(h[j])){const e=y.get(a[k]),t=void 0!==e?d[e]:null;if(null===t){const e=v(s,d[x]);u$1(e,p$1[k]),v$1[k]=e;}else v$1[k]=u$1(t,p$1[k]),v(s,d[x],t),d[e]=null;k++;}else h$1(d[j]),j--;else h$1(d[x]),x++;for(;k<=w;){const e=v(s,v$1[w+1]);u$1(e,p$1[k]),v$1[k++]=e;}for(;x<=j;){const e=d[x++];null!==e&&h$1(e);}return this.ut=a,p(s,v$1),E}});
...
const comboboxStyles = "@charset \"UTF-8\";@layer reset,components,utilities;@layer components{.combobox-field{display:flex;flex-direction:column;gap:var(--vi-combobox-spacing-field-gap, var(--vi-spacing-xs, 8px));width:100%;position:relative}.combobox-control{display:flex;align-items:center;flex-wrap:wrap;gap:var(--vi-combobox-tag-gap, var(--vi-spacing-xs, 8px));box-sizing:border-box;width:100%;min-height:var(--vi-combobox-min-height, 40px);padding:var(--vi-combobox-padding-block, var(--vi-spacing-xs, 8px)) var(--vi-combobox-padding-inline, var(--vi-spacing-sm, 16px));background-color:var(--vi-combobox-background, var(--vi-color-background, #ffffff));border:var(--vi-combobox-border-width, var(--vi-border-width-thin, 1px)) solid var(--vi-combobox-border-color, var(--vi-border-03, #e0e0e0));border-radius:var(--vi-combobox-border-radius, var(--vi-border-radius-lg, 8px));font-family:var(--vi-font-family-base, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif);font-size:var(--vi-combobox-font-size, var(--vi-font-size-base, 16px));color:var(--vi-combobox-text-color, var(--vi-text-primary, #111827));transition:border-color .15s ease,box-shadow .15s ease;cursor:text;position:relative}.combobox-control:hover:not(.is-disabled):not(.is-focused){border-color:var(--vi-combobox-border-color-hover, var(--vi-border-04, #bdbdbd))}.combobox-control.is-focused,.combobox-control:focus-within{border-color:var(--vi-combobox-border-color-focus, var(--vi-focus, #3676d0));outline:var(--vi-combobox-border-width-focus, var(--vi-border-width-base, 2px)) solid var(--vi-combobox-focus-ring-color, var(--vi-focus, #3676d0));outline-offset:0;box-shadow:0 0 0 3px var(--vi-combobox-focus-ring-glow, var(--vi-color-blue-200, #cee6ff))}.combobox-control.is-disabled{opacity:var(--vi-combobox-disabled-opacity, .6);pointer-events:none;cursor:not-allowed}.combobox-control.is-invalid{border-color:var(--vi-combobox-error-color, var(--vi-color-error, #ef4444))}.combobox-control.is-invalid.is-focused,.combobox-control.is-invalid:focus-within{outline-color:var(--vi-combobox-error-color, var(--vi-color-error, #ef4444))}.combobox-control.is-valid{border-color:var(--vi-combobox-success-color, var(--vi-color-success, #489167))}.combobox-input{appearance:none;-webkit-appearance:none;flex:1 1 60px;min-width:60px;border:none;outline:none;background:transparent;padding:0;margin:0;font-family:inherit;font-size:inherit;color:inherit;line-height:var(--vi-line-height-normal, 1.5)}.combobox-input::placeholder{color:var(--vi-combobox-placeholder-color, var(--vi-text-secondary, #4b5563))}.combobox-chevron{margin-left:auto;color:var(--vi-combobox-chevron-color, var(--vi-text-secondary, #4b5563));flex-shrink:0;transition:transform .2s cubic-bezier(.2,0,0,1);transform-origin:center center;pointer-events:auto;cursor:pointer;width:18px;height:18px}.combobox-control.is-open .combobox-chevron{transform:rotate(180deg)}.combobox-clear-btn{appearance:none;-webkit-appearance:none;background:transparent;border:none;padding:2px;margin:0;display:inline-flex;align-items:center;justify-content:center;color:var(--vi-combobox-clear-color, var(--vi-text-secondary, #4b5563));cursor:pointer;border-radius:var(--vi-border-radius-sm, 2px);transition:color .15s ease,background-color .15s ease;width:20px;height:20px;flex-shrink:0}.combobox-clear-btn:hover{color:var(--vi-combobox-clear-hover-color, var(--vi-text-primary, #111827));background-color:var(--vi-combobox-clear-hover-bg, var(--vi-layer-hover-01, #f3f4f6))}.combobox-trigger{appearance:none;-webkit-appearance:none;flex:1 1 0px;min-width:0;display:inline-flex;align-items:center;border:none;outline:none;background:transparent;padding:0;margin:0;font-family:inherit;font-size:inherit;color:inherit;line-height:inherit;text-align:left;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;cursor:pointer}.combobox-trigger.is-placeholder{color:var(--vi-combobox-placeholder-color, var(--vi-text-secondary, #4b5563))}.combobox-tags{display:flex;flex-wrap:wrap;align-items:center;gap:var(--vi-combobox-tag-gap, var(--vi-spacing-xs, 8px))}.combobox-listbox{box-sizing:border-box;position:absolute;top:0;left:0;z-index:var(--vi-combobox-listbox-z-index, 1000);height:var(--vi-combobox-listbox-height, auto);max-height:var(--vi-combobox-listbox-max-height, 280px);overflow-y:auto;background-color:var(--vi-combobox-listbox-background, var(--vi-layer-01, #ffffff));border:1px solid var(--vi-combobox-listbox-border-color, var(--vi-border-02, #eeeeee));border-radius:var(--vi-combobox-listbox-border-radius, var(--vi-border-radius-lg, 8px));box-shadow:var(--vi-combobox-listbox-shadow, var(--vi-shadow-md, 0 4px 6px -1px rgba(0, 0, 0, .1)));padding:4px 0;margin:0;opacity:0;visibility:hidden;transform:translateY(-6px) scale(.98);transform-origin:top center;transition:opacity .16s cubic-bezier(.2,0,0,1),transform .16s cubic-bezier(.2,0,0,1),visibility .16s cubic-bezier(.2,0,0,1);pointer-events:none}.combobox-listbox[data-placement^=top]{transform-origin:bottom center;transform:translateY(6px) scale(.98)}.combobox-listbox[open],.combobox-listbox.is-open{opacity:1;visibility:visible;transform:translateY(0) scale(1);pointer-events:auto}.combobox-list{list-style:none;margin:0;padding:0}.combobox-option{display:flex;align-items:center;justify-content:space-between;gap:var(--vi-combobox-option-gap, var(--vi-spacing-xs, 8px));min-height:var(--vi-combobox-option-height, 40px);padding:var(--vi-combobox-option-padding-block, var(--vi-spacing-xs, 8px)) var(--vi-combobox-option-padding-inline, var(--vi-spacing-sm, 16px));font-size:var(--vi-combobox-option-font-size, var(--vi-font-size-base, 16px));color:var(--vi-combobox-option-color, var(--vi-text-primary, #111827));cursor:pointer;-webkit-user-select:none;user-select:none}.combobox-option:hover,.combobox-option.is-active{background-color:var(--vi-combobox-option-hover-bg, var(--vi-layer-hover-01, #f3f4f6))}.combobox-option.is-selected{background-color:var(--vi-combobox-option-selected-bg, var(--vi-layer-02, #f3f4f6));color:var(--vi-combobox-option-selected-color, var(--vi-color-primary, #3676d0));font-weight:var(--vi-font-weight-semibold, 600)}.combobox-option.is-disabled{color:var(--vi-combobox-option-disabled-color, var(--vi-text-disabled, #9e9e9e));cursor:not-allowed;pointer-events:none;opacity:.6}.combobox-option-content{display:flex;flex-direction:column;flex:1 1 auto;overflow:hidden}.combobox-option-label{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.combobox-option-description{font-size:var(--vi-combobox-option-description-font-size, var(--vi-font-size-sm, 14px));color:var(--vi-combobox-option-description-color, var(--vi-text-secondary, #4b5563));white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.combobox-option-action{display:flex;align-items:center;margin-left:auto;z-index:1}.combobox-mark{background-color:var(--vi-combobox-mark-background, var(--vi-bg-warning, #fff8e1));color:var(--vi-combobox-mark-color, var(--vi-text-primary, #111827));border-radius:var(--vi-border-radius-sm, 2px);padding:0 1px}.combobox-group-header{padding:8px var(--vi-combobox-group-padding-inline, var(--vi-spacing-sm, 16px)) 4px;font-size:var(--vi-combobox-group-font-size, var(--vi-font-size-xs, 12px));font-weight:var(--vi-combobox-group-font-weight, var(--vi-font-weight-semibold, 600));color:var(--vi-combobox-group-color, var(--vi-text-secondary, #4b5563));text-transform:uppercase;letter-spacing:var(--vi-letter-spacing-wide, .025em);-webkit-user-select:none;user-select:none}.combobox-empty,.combobox-loading{padding:var(--vi-spacing-sm, 16px);text-align:center;font-size:var(--vi-font-size-sm, 14px);color:var(--vi-text-secondary, #4b5563)}.combobox-helper{font-size:var(--vi-combobox-validation-font-size, var(--vi-font-size-xs, 12px));color:var(--vi-combobox-helper-color, var(--vi-text-helper, #9e9e9e))}.combobox-validation{font-size:var(--vi-combobox-validation-font-size, var(--vi-font-size-xs, 12px));color:var(--vi-combobox-error-color, var(--vi-color-error, #ef4444))}.combobox-validation.is-valid{color:var(--vi-combobox-success-color, var(--vi-color-success, #489167))}@media(prefers-reduced-motion:reduce){.combobox-control,.combobox-option{transition:none}}}:host{display:block}:host([hidden]){display:none!important}:host([searchable=false]) .combobox-control{cursor:pointer}.combobox-listbox{max-height:var(--vi-combobox-listbox-max-height, 300px)}.combobox-option{width:100%;box-sizing:border-box;border-bottom:1px solid var(--vi-border-02, #eeeeee)}.combobox-option:last-child{border-bottom:none}";
