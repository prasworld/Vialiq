...
const accordionStyles = "@charset \"UTF-8\";@layer reset,components,utilities;.accordion{display:flex;flex-direction:column;gap:var(--vi-accordion-gap, 0px);width:100%}.accordion-item{display:flex;flex-direction:column;width:100%;box-sizing:border-box}.accordion-item:not(:last-child){border-bottom:1px solid var(--vi-accordion-border-color, var(--vi-outline, #e5e7eb))}.accordion-header{display:flex;align-items:center;justify-content:space-between;width:100%;padding:var(--vi-accordion-item-header-padding, var(--vi-spacing-sm, .75rem) var(--vi-spacing-md, 1rem));background-color:var(--vi-accordion-item-header-bg, transparent);color:var(--vi-accordion-item-label-color, var(--vi-text-primary, #111827));font-family:var(--vi-accordion-font-family, var(--vi-font-family-base, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif));font-size:var(--vi-accordion-item-header-font-size, var(--vi-font-size-base, .875rem));font-weight:var(--vi-accordion-item-label-font-weight, var(--vi-font-weight-medium, 500));text-align:left;border:none;outline:none;cursor:pointer;box-sizing:border-box;transition:background-color var(--vi-accordion-animation-duration, .2s) ease,color var(--vi-accordion-animation-duration, .2s) ease;-webkit-user-select:none;user-select:none}.accordion-header:hover:not(:disabled){background-color:var(--vi-accordion-item-header-bg-hover, var(--vi-layer-hover-01, #f3f4f6))}.accordion-header:disabled{cursor:not-allowed;opacity:.5}.accordion-header:focus-visible{outline:2px solid var(--vi-focus, #3676d0);outline-offset:-2px}.accordion-header-content{display:flex;align-items:center;gap:var(--vi-spacing-xs, .5rem);flex:1}.accordion-label{flex:1}.accordion-chevron{display:inline-flex;align-items:center;justify-content:center;color:var(--vi-accordion-item-chevron-color, var(--vi-text-disabled, #9e9e9e));transition:transform var(--vi-accordion-animation-duration, .2s) ease;margin-inline-start:var(--vi-spacing-xs, .5rem)}.accordion-chevron svg{width:var(--vi-spacing-md, 1rem);height:var(--vi-spacing-md, 1rem);fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.accordion-panel{display:block;overflow:hidden;max-height:0;opacity:0;transition:max-height var(--vi-accordion-animation-duration, .2s) ease-out,opacity var(--vi-accordion-animation-duration, .2s) ease-out}.accordion-panel-inner{padding:var(--vi-accordion-item-body-padding, 0 var(--vi-spacing-md, 1rem) var(--vi-spacing-md, 1rem));font-family:var(--vi-accordion-font-family, var(--vi-font-family-base, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif));font-size:var(--vi-font-size-sm, .8125rem);color:var(--vi-text-secondary, #4b5563);box-sizing:border-box}.accordion--bordered{border:1px solid var(--vi-accordion-border-color, var(--vi-outline, #e5e7eb));border-radius:var(--vi-accordion-border-radius, var(--vi-border-radius-md, 6px));overflow:hidden}.accordion--bordered .accordion-item:last-child{border-bottom:none}.accordion--flush,.accordion-item--flush{border:none;border-radius:0}.accordion--flush .accordion-item,.accordion-item--flush .accordion-item,.accordion--flush,.accordion-item--flush{border-inline:none}.accordion--card{--vi-accordion-gap: 8px}.accordion-item--card{border:1px solid var(--vi-accordion-border-color, var(--vi-outline, #e5e7eb));border-radius:var(--vi-accordion-border-radius, var(--vi-border-radius-md, 6px));background-color:var(--vi-card-bg, var(--vi-layer-01, #ffffff));box-shadow:var(--vi-shadow-sm, var(--vi-shadow-sm, 0 1px 2px 0 rgba(0, 0, 0, .03)));overflow:hidden}.accordion-item--card:not(:last-child){border-bottom:1px solid var(--vi-accordion-border-color, var(--vi-outline, #e5e7eb))}.accordion--sm,.accordion-item--sm{--vi-accordion-item-header-padding: var(--vi-spacing-xs, .5rem) var(--vi-spacing-sm, .75rem);--vi-accordion-item-body-padding: 0 var(--vi-spacing-sm, .75rem) var(--vi-spacing-sm, .75rem);--vi-accordion-item-header-font-size: var(--vi-font-size-sm, .8125rem)}.accordion--md,.accordion-item--md{--vi-accordion-item-header-padding: 14px 16px;--vi-accordion-item-body-padding: 0 16px 16px;--vi-accordion-item-header-font-size: var(--vi-font-size-base, .875rem)}.accordion--lg,.accordion-item--lg{--vi-accordion-item-header-padding: var(--vi-spacing-lg, 1.5rem) var(--vi-spacing-xl, 2rem);--vi-accordion-item-body-padding: 0 var(--vi-spacing-xl, 2rem) var(--vi-spacing-xl, 2rem);--vi-accordion-item-header-font-size: var(--vi-font-size-lg, 1rem)}.accordion-item--open .accordion-header{background-color:var(--vi-accordion-item-header-bg-open, transparent)}.accordion-item--open .accordion-chevron{transform:rotate(90deg)}.accordion-item--open .accordion-panel{max-height:var(--vi-accordion-panel-height, none);opacity:1}@media(prefers-reduced-motion:reduce){.accordion-panel,.accordion-chevron,.accordion-header{transition:none!important}}:host{display:block;width:100%}";
