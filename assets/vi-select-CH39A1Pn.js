import { r as r$1, i, b, c as i$1 } from './iframe-DeJCTnW8.js';
...
new class extends _identity {
  ...
  `;
            ...
            _selectOption(opt) {
                ...
                this.close();
                this.dispatchEvent(new CustomEvent('vi-select-change', {
                    detail: {
                        value: this.value,
                        label: opt.label
                    },
            ...
            clear() {
                ...
                this.value = '';
                this._selectedLabel = '';
                this.dispatchEvent(new CustomEvent('vi-select-clear', {
                    bubbles: true,
                    composed: true
                }));
                this.dispatchEvent(new CustomEvent('vi-select-change', {
