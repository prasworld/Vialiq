import { r, i, b } from './iframe-DeJCTnW8.js';
...
import { i as ifNonEmpty } from './if-non-empty-B3I8MmSB.js';

const inputStyles = "@charset \"UTF-8\";@layer reset,components,utilities;@layer components{.input-field{display:flex;flex-direction:column;gap:var(--vi-input-spacing-field-gap, var(--vi-spacing-xs, .5rem));width:100%}.input-control{appearance:none;-webkit-appearance:none;display:block;width:100%;box-sizing:border-box;min-height:var(--vi-input-sizing-min-height, 40px);border:var(--vi-border-width-thin, 1px) solid var(--vi-input-border-color, var(--vi-outline, #e5e7eb));border-radius:var(--vi-input-shape-border-radius, var(--vi-border-radius-lg, 8px));padding:var(--vi-input-spacing-padding-block, var(--vi-spacing-xs, .5rem)) var(--vi-input-spacing-padding-inline, var(--vi-spacing-sm, .75rem));font-family:var(--vi-font-family-base, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif);font-size:var(--vi-input-typography-font-size, var(--vi-font-size-base, .875rem));font-weight:var(--vi-font-weight-normal, 400);line-height:var(--vi-input-typography-line-height, var(--vi-line-height-normal, 1.5715));color:var(--vi-input-text-color, var(--vi-text-primary, #111827));background-color:var(--vi-input-background-color, var(--vi-color-background, #ffffff));transition:border-color .15s ease,box-shadow .15s ease}.input-control:hover:not(:focus-visible){border-color:var(--vi-input-border-color-hover, var(--vi-text-secondary, #4b5563))}.input-control:focus-visible,.input-control:focus{outline:var(--vi-border-width-base, 2px) solid var(--vi-input-focus-ring-color, var(--vi-focus, #3676d0));outline-offset:0;box-shadow:var(--vi-focus-ring-shadow, 0 0 0 3px var(--vi-focus-ring-color, var(--vi-color-blue-200, #cee6ff)))}.input-control::placeholder{color:var(--vi-input-placeholder-color, var(--vi-text-secondary, #4b5563))}.input-control:disabled{cursor:not-allowed;background-color:var(--vi-input-bg-disabled, var(--vi-layer-disabled, #f3f4f6));color:var(--vi-input-text-disabled, var(--vi-text-disabled, #9e9e9e));border-color:var(--vi-input-border-disabled, var(--vi-border-02, #eeeeee))}.input-helper{font-size:var(--vi-input-helper-size, var(--vi-font-size-xs, .75rem));line-height:var(--vi-input-helper-leading, var(--vi-line-height-normal, 1.5715));color:var(--vi-input-helper-color, var(--vi-text-helper, #9e9e9e))}.input-error{font-size:var(--vi-input-error-size, var(--vi-font-size-xs, .75rem));line-height:var(--vi-input-error-leading, var(--vi-line-height-normal, 1.5715));color:var(--vi-input-error-color, var(--vi-color-error, #ef4444))}@media(prefers-reduced-motion:reduce){.input-control{transition:none}}}:host{display:block;outline:none}.input-control{padding-block:var(--vi-input-spacing-padding-block, var(--vi-spacing-unit, .25rem));padding-inline:var(--vi-input-spacing-padding-inline, var(--vi-spacing-sm, .75rem));font-size:var(--vi-input-typography-font-size, var(--vi-font-size-base, .875rem));border-radius:var(--vi-input-shape-border-radius, var(--vi-border-radius-md, 6px));min-height:var(--vi-input-sizing-min-height, 32px)}:host([disabled]){cursor:not-allowed}:host([status=invalid]){--vi-input-border-color: var(--vi-color-error, #ef4444);--vi-input-border-color-hover: var(--vi-color-error, #ef4444);--vi-input-focus-ring-color: var(--vi-color-error, #ef4444);--vi-input-focus-ring-glow: var(--vi-color-red-100, #ffccce);--vi-input-label-color: var(--vi-color-error, #ef4444)}:host([status=valid]){--vi-input-border-color: var(--vi-color-success, #489167);--vi-input-border-color-hover: var(--vi-color-success, #489167);--vi-input-focus-ring-color: var(--vi-color-success, #489167);--vi-input-focus-ring-glow: var(--vi-color-green-100, #e6f0eb)}.input-validation{font-family:var(--vi-font-family-base, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif);font-size:var(--vi-font-size-xs, .75rem);line-height:var(--vi-line-height-normal, 1.5715);letter-spacing:var(--vi-letter-spacing-wider, .05em);color:var(--vi-input-helper-color, var(--vi-text-helper, #9e9e9e))}.input-validation--invalid{color:var(--vi-input-error-color, var(--vi-color-error, #ef4444))}.input-validation--valid{color:var(--vi-input-success-color, var(--vi-color-success, #489167))}::slotted([slot=helper]){font-family:var(--vi-font-family-base, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif);font-size:var(--vi-font-size-xs, .75rem);line-height:var(--vi-line-height-normal, 1.5715);letter-spacing:var(--vi-letter-spacing-wider, .05em);color:var(--vi-input-helper-color, var(--vi-text-helper, #9e9e9e))}:host([size=xs]) .input-control{padding-block:var(--vi-input-spacing-padding-block, 0px);padding-inline:var(--vi-input-spacing-padding-inline, var(--vi-spacing-unit, .25rem));font-size:var(--vi-input-typography-font-size, var(--vi-font-size-xs, .75rem));border-radius:var(--vi-input-shape-border-radius, var(--vi-border-radius-sm, 4px));min-height:var(--vi-input-sizing-min-height, 20px)}:host([size=sm]) .input-control{padding-block:var(--vi-input-spacing-padding-block, 0px);padding-inline:var(--vi-input-spacing-padding-inline, var(--vi-spacing-xs, .5rem));font-size:var(--vi-input-typography-font-size, var(--vi-font-size-base, .875rem));border-radius:var(--vi-input-shape-border-radius, var(--vi-border-radius-sm, 4px));min-height:var(--vi-input-sizing-min-height, 24px)}:host([size=lg]) .input-control{padding-block:var(--vi-input-spacing-padding-block, var(--vi-spacing-xs, .5rem));padding-inline:var(--vi-input-spacing-padding-inline, var(--vi-spacing-sm, .75rem));font-size:var(--vi-input-typography-font-size, var(--vi-font-size-lg, 1rem));border-radius:var(--vi-input-shape-border-radius, var(--vi-border-radius-lg, 8px));min-height:var(--vi-input-sizing-min-height, 40px)}";
