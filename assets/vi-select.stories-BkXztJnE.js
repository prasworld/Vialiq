import { r as r$1, i, b, c as i$1 } from './iframe-DLZvjPtb.js';
...
import { i as ifNonEmpty } from './if-non-empty-C0WlpPAT.js';
...
import { F as FloatingController, L as ListboxKeyboardController } from './keyboard-controller-B3hXl2lI.js';
import { c as checkIcon } from './check-D9SDO18H.js';
import './preload-helper-D5QYaGzd.js';
import './base-Cl6v8-BZ.js';
import './if-defined-B62nKUJ_.js';
import './directive-BKuZRRPO.js';
import './floating-ui.dom-DwUTpXgb.js';

const selectStyles = "@charset \"UTF-8\";@layer reset,components,utilities;@layer components{.select-field{display:flex;flex-direction:column;gap:var(--vi-select-spacing-field-gap, var(--vi-spacing-xs, 8px));width:var(--vi-select-width, 100%);position:relative}.select-wrapper{position:relative;display:flex;flex-direction:column;width:100%}.select-trigger{display:flex;align-items:center;justify-content:space-between;box-sizing:border-box;width:100%;min-height:var(--vi-select-sizing-min-height, 40px);padding:var(--vi-select-spacing-padding-block, var(--vi-spacing-xs, 8px)) var(--vi-select-spacing-padding-inline, var(--vi-spacing-sm, 16px));background-color:var(--vi-select-background-color, var(--vi-color-background, #ffffff));border:var(--vi-select-border-width, var(--vi-border-width-thin, 1px)) solid var(--vi-select-border-color, var(--vi-border-03, #e0e0e0));border-radius:var(--vi-select-shape-border-radius, var(--vi-border-radius-lg, 8px));font-family:inherit;font-size:var(--vi-font-size-base, var(--vi-font-size-base, 16px));color:var(--vi-select-text-color, var(--vi-color-foreground, #111827));transition:border-color .15s ease,box-shadow .15s ease;cursor:pointer;text-align:left;white-space:nowrap}.select-trigger:hover:not(.is-disabled){border-color:var(--vi-select-border-color-hover, var(--vi-border-04, #bdbdbd))}.select-trigger.is-placeholder{color:var(--vi-select-placeholder-color, var(--vi-text-secondary, #4b5563))}.select-trigger.is-disabled{background-color:var(--vi-layer-disabled, var(--vi-layer-disabled, #f3f4f6))}.select-trigger:focus-visible{border-color:var(--vi-select-focus-ring-color, var(--vi-focus, #3676d0));outline:var(--vi-border-width-base, 2px) solid var(--vi-select-focus-ring-color, var(--vi-focus, #3676d0));outline-offset:-1px;box-shadow:0 0 0 3px var(--vi-select-focus-ring-glow, var(--vi-color-blue-200, #cee6ff))}.select-label-container{display:grid;flex:1 1 0%;min-width:0;align-items:center}.select-label{grid-area:1/1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.select-label.is-wrapped{white-space:normal;overflow:visible;text-overflow:clip;word-break:break-word}.select-measurer{grid-area:1/1;visibility:hidden;height:0;overflow:hidden;pointer-events:none;-webkit-user-select:none;user-select:none}.select-measurer>span{display:block;white-space:nowrap}.select-icons{display:flex;align-items:center;gap:var(--vi-spacing-xs, 8px);flex-shrink:0;z-index:2;position:relative;color:var(--vi-select-arrow-color, var(--vi-text-secondary, #4b5563))}.select-chevron{width:18px;height:18px;pointer-events:none}.select-clear-btn{appearance:none;-webkit-appearance:none;background:transparent;border:none;padding:2px;margin:0;display:inline-flex;align-items:center;justify-content:center;color:var(--vi-select-arrow-color, var(--vi-text-secondary, #4b5563));cursor:pointer;border-radius:var(--vi-border-radius-sm, 2px);transition:color .15s ease,background-color .15s ease;width:20px;height:20px;flex-shrink:0}.select-clear-btn:hover{color:var(--vi-text-primary, #111827);background-color:var(--vi-layer-hover-01, #f3f4f6)}.select-clear-btn[hidden]{display:none}.select-listbox{margin:0;padding:var(--vi-select-listbox-padding, var(--vi-spacing-xs, 8px) 0);list-style:none;background-color:var(--vi-select-listbox-background, var(--vi-layer-01, #ffffff));border:var(--vi-border-width-base, 1px) solid var(--vi-select-listbox-border-color, var(--vi-border-02, #eeeeee));border-radius:var(--vi-select-shape-border-radius, var(--vi-border-radius-lg, 8px));box-shadow:var(--vi-select-listbox-shadow, var(--vi-shadow-md, 0 4px 6px -1px rgba(0, 0, 0, .1)));max-height:var(--vi-select-listbox-max-height, 300px);overflow-y:auto;z-index:1000;box-sizing:border-box;width:100%}.select-listbox:focus{outline:none}.select-listbox[hidden]{display:none!important}.select-option{display:flex;align-items:center;gap:var(--vi-spacing-sm, 16px);padding:var(--vi-select-option-padding-block, 10px) var(--vi-select-option-padding-inline, var(--vi-spacing-md, 24px));cursor:pointer;font-family:inherit;font-size:var(--vi-font-size-base, var(--vi-font-size-base, 16px));color:var(--vi-select-option-text-color, var(--vi-text-primary, #111827));background-color:transparent;transition:background-color .15s ease,color .15s ease;width:100%;box-sizing:border-box}.select-option:hover:not(.is-disabled){background-color:var(--vi-select-option-hover-bg, var(--vi-layer-hover-01, #f3f4f6))}.select-option.is-active:not(.is-disabled){background-color:var(--vi-select-option-active-bg, var(--vi-layer-02, #f3f4f6))}.select-option.is-selected{font-weight:var(--vi-font-weight-medium, 500);background-color:var(--vi-select-option-selected-bg, var(--vi-layer-02, #f3f4f6))}.select-option.is-disabled{color:var(--vi-select-option-disabled-color, var(--vi-text-disabled, #9e9e9e));cursor:not-allowed;opacity:.6}.select-option-icon{flex-shrink:0;color:var(--vi-select-option-icon-color, var(--vi-text-secondary, #4b5563));width:18px;height:18px}.select-option-check{flex-shrink:0;color:var(--vi-select-option-check-color, var(--vi-color-primary, #3676d0));width:16px;height:16px;margin-left:auto}.select-option-content{display:flex;flex-direction:column;flex-grow:1;overflow:hidden}.select-option-label{flex:1 1 0%;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block}.select-option-label.is-wrapped{white-space:normal;overflow:visible;text-overflow:clip;word-break:break-word}.select-option-description{font-size:var(--vi-font-size-sm, var(--vi-font-size-xs, 12px));color:var(--vi-text-secondary, var(--vi-text-secondary, #4b5563));margin-top:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block}.select-native{position:absolute;inset:0;width:100%;height:100%;opacity:0;appearance:none;-webkit-appearance:none;cursor:pointer;z-index:1}.select-native:disabled{cursor:not-allowed}.select-native:focus-visible+.select-trigger{border-color:var(--vi-select-focus-ring-color, var(--vi-focus, #3676d0));outline:var(--vi-border-width-base, 2px) solid var(--vi-select-focus-ring-color, var(--vi-focus, #3676d0));outline-offset:-1px;box-shadow:0 0 0 3px var(--vi-select-focus-ring-glow, var(--vi-color-blue-200, #cee6ff))}.select-wrapper.is-invalid .select-trigger{border-color:var(--vi-color-error, var(--vi-color-error, #ef4444))}.select-wrapper.is-invalid .select-trigger .select-native:focus-visible+.select-trigger{outline-color:var(--vi-color-error, var(--vi-color-error, #ef4444));box-shadow:none}.select-wrapper.is-valid .select-trigger{border-color:var(--vi-color-success, var(--vi-color-success, #489167))}.select-helper{font-size:var(--vi-font-size-sm, var(--vi-font-size-xs, 12px));color:var(--vi-text-helper, var(--vi-text-helper, #9e9e9e))}.select-validation{font-size:var(--vi-font-size-sm, var(--vi-font-size-xs, 12px));color:var(--vi-color-error, var(--vi-color-error, #ef4444))}.select-validation.is-valid{color:var(--vi-color-success, var(--vi-color-success, #489167))}.select-validation[hidden]{display:none}}:host{display:block}:host([hidden]){display:none!important}:host([disabled]){pointer-events:none}:host([disabled]) .select-wrapper{opacity:var(--vi-select-disabled-opacity, .6)}";

const optionStyles = "@charset \"UTF-8\";@layer reset,components,utilities;@layer components{.select-field{display:flex;flex-direction:column;gap:var(--vi-select-spacing-field-gap, var(--vi-spacing-xs, 8px));width:var(--vi-select-width, 100%);position:relative}.select-wrapper{position:relative;display:flex;flex-direction:column;width:100%}.select-trigger{display:flex;align-items:center;justify-content:space-between;box-sizing:border-box;width:100%;min-height:var(--vi-select-sizing-min-height, 40px);padding:var(--vi-select-spacing-padding-block, var(--vi-spacing-xs, 8px)) var(--vi-select-spacing-padding-inline, var(--vi-spacing-sm, 16px));background-color:var(--vi-select-background-color, var(--vi-color-background, #ffffff));border:var(--vi-select-border-width, var(--vi-border-width-thin, 1px)) solid var(--vi-select-border-color, var(--vi-border-03, #e0e0e0));border-radius:var(--vi-select-shape-border-radius, var(--vi-border-radius-lg, 8px));font-family:inherit;font-size:var(--vi-font-size-base, var(--vi-font-size-base, 16px));color:var(--vi-select-text-color, var(--vi-color-foreground, #111827));transition:border-color .15s ease,box-shadow .15s ease;cursor:pointer;text-align:left;white-space:nowrap}.select-trigger:hover:not(.is-disabled){border-color:var(--vi-select-border-color-hover, var(--vi-border-04, #bdbdbd))}.select-trigger.is-placeholder{color:var(--vi-select-placeholder-color, var(--vi-text-secondary, #4b5563))}.select-trigger.is-disabled{background-color:var(--vi-layer-disabled, var(--vi-layer-disabled, #f3f4f6))}.select-trigger:focus-visible{border-color:var(--vi-select-focus-ring-color, var(--vi-focus, #3676d0));outline:var(--vi-border-width-base, 2px) solid var(--vi-select-focus-ring-color, var(--vi-focus, #3676d0));outline-offset:-1px;box-shadow:0 0 0 3px var(--vi-select-focus-ring-glow, var(--vi-color-blue-200, #cee6ff))}.select-label-container{display:grid;flex:1 1 0%;min-width:0;align-items:center}.select-label{grid-area:1/1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.select-label.is-wrapped{white-space:normal;overflow:visible;text-overflow:clip;word-break:break-word}.select-measurer{grid-area:1/1;visibility:hidden;height:0;overflow:hidden;pointer-events:none;-webkit-user-select:none;user-select:none}.select-measurer>span{display:block;white-space:nowrap}.select-icons{display:flex;align-items:center;gap:var(--vi-spacing-xs, 8px);flex-shrink:0;z-index:2;position:relative;color:var(--vi-select-arrow-color, var(--vi-text-secondary, #4b5563))}.select-chevron{width:18px;height:18px;pointer-events:none}.select-clear-btn{appearance:none;-webkit-appearance:none;background:transparent;border:none;padding:2px;margin:0;display:inline-flex;align-items:center;justify-content:center;color:var(--vi-select-arrow-color, var(--vi-text-secondary, #4b5563));cursor:pointer;border-radius:var(--vi-border-radius-sm, 2px);transition:color .15s ease,background-color .15s ease;width:20px;height:20px;flex-shrink:0}.select-clear-btn:hover{color:var(--vi-text-primary, #111827);background-color:var(--vi-layer-hover-01, #f3f4f6)}.select-clear-btn[hidden]{display:none}.select-listbox{margin:0;padding:var(--vi-select-listbox-padding, var(--vi-spacing-xs, 8px) 0);list-style:none;background-color:var(--vi-select-listbox-background, var(--vi-layer-01, #ffffff));border:var(--vi-border-width-base, 1px) solid var(--vi-select-listbox-border-color, var(--vi-border-02, #eeeeee));border-radius:var(--vi-select-shape-border-radius, var(--vi-border-radius-lg, 8px));box-shadow:var(--vi-select-listbox-shadow, var(--vi-shadow-md, 0 4px 6px -1px rgba(0, 0, 0, .1)));max-height:var(--vi-select-listbox-max-height, 300px);overflow-y:auto;z-index:1000;box-sizing:border-box;width:100%}.select-listbox:focus{outline:none}.select-listbox[hidden]{display:none!important}.select-option{display:flex;align-items:center;gap:var(--vi-spacing-sm, 16px);padding:var(--vi-select-option-padding-block, 10px) var(--vi-select-option-padding-inline, var(--vi-spacing-md, 24px));cursor:pointer;font-family:inherit;font-size:var(--vi-font-size-base, var(--vi-font-size-base, 16px));color:var(--vi-select-option-text-color, var(--vi-text-primary, #111827));background-color:transparent;transition:background-color .15s ease,color .15s ease;width:100%;box-sizing:border-box}.select-option:hover:not(.is-disabled){background-color:var(--vi-select-option-hover-bg, var(--vi-layer-hover-01, #f3f4f6))}.select-option.is-active:not(.is-disabled){background-color:var(--vi-select-option-active-bg, var(--vi-layer-02, #f3f4f6))}.select-option.is-selected{font-weight:var(--vi-font-weight-medium, 500);background-color:var(--vi-select-option-selected-bg, var(--vi-layer-02, #f3f4f6))}.select-option.is-disabled{color:var(--vi-select-option-disabled-color, var(--vi-text-disabled, #9e9e9e));cursor:not-allowed;opacity:.6}.select-option-icon{flex-shrink:0;color:var(--vi-select-option-icon-color, var(--vi-text-secondary, #4b5563));width:18px;height:18px}.select-option-check{flex-shrink:0;color:var(--vi-select-option-check-color, var(--vi-color-primary, #3676d0));width:16px;height:16px;margin-left:auto}.select-option-content{display:flex;flex-direction:column;flex-grow:1;overflow:hidden}.select-option-label{flex:1 1 0%;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block}.select-option-label.is-wrapped{white-space:normal;overflow:visible;text-overflow:clip;word-break:break-word}.select-option-description{font-size:var(--vi-font-size-sm, var(--vi-font-size-xs, 12px));color:var(--vi-text-secondary, var(--vi-text-secondary, #4b5563));margin-top:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block}.select-native{position:absolute;inset:0;width:100%;height:100%;opacity:0;appearance:none;-webkit-appearance:none;cursor:pointer;z-index:1}.select-native:disabled{cursor:not-allowed}.select-native:focus-visible+.select-trigger{border-color:var(--vi-select-focus-ring-color, var(--vi-focus, #3676d0));outline:var(--vi-border-width-base, 2px) solid var(--vi-select-focus-ring-color, var(--vi-focus, #3676d0));outline-offset:-1px;box-shadow:0 0 0 3px var(--vi-select-focus-ring-glow, var(--vi-color-blue-200, #cee6ff))}.select-wrapper.is-invalid .select-trigger{border-color:var(--vi-color-error, var(--vi-color-error, #ef4444))}.select-wrapper.is-invalid .select-trigger .select-native:focus-visible+.select-trigger{outline-color:var(--vi-color-error, var(--vi-color-error, #ef4444));box-shadow:none}.select-wrapper.is-valid .select-trigger{border-color:var(--vi-color-success, var(--vi-color-success, #489167))}.select-helper{font-size:var(--vi-font-size-sm, var(--vi-font-size-xs, 12px));color:var(--vi-text-helper, var(--vi-text-helper, #9e9e9e))}.select-validation{font-size:var(--vi-font-size-sm, var(--vi-font-size-xs, 12px));color:var(--vi-color-error, var(--vi-color-error, #ef4444))}.select-validation.is-valid{color:var(--vi-color-success, var(--vi-color-success, #489167))}.select-validation[hidden]{display:none}}:host{display:block}:host([hidden]){display:none!important}mark{background-color:transparent;color:inherit}mark.highlight{background-color:var(--vi-typeahead-highlight-bg, #ebf5ff);color:var(--vi-typeahead-highlight-color, #3676d0);font-weight:600;border-radius:2px;padding:0 1px}";
...
class ViSelectGroup extends (_LitElement = i$1) {
    ...
    render() {
      ...
      <div class="select-group">
        ${this.label ? b`<div class="select-group-header" part="header">${this.label}</div>` : ''}
        <slot></slot>
      </div>
    `;
    }
...
_dec = t('vi-select'), _dec1 = n({
    ...
    attribute: false
}), _dec14 = r(), _dec15 = r(), _dec16 = r(), _dec17 = e$1('.select-trigger'), _dec18 = e$1('.select-listbox'), _dec19 = r();
          ...
          >
            <div class="select-label-container">
              ...
              <div class="select-measurer" aria-hidden="true">
                ...
                ${this._slottedItems.map((item)=>b`<span>${item.label || item.textContent?.trim() || ''}</span>`)}
              </div>
            </div>
