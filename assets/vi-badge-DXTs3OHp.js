...
const badgeStyles = "@charset \"UTF-8\";@layer reset,components,utilities;@layer components{.badge{display:inline-flex;align-items:center;justify-content:center;white-space:nowrap;box-sizing:border-box;height:var(--vi-badge-height, 20px);font-size:var(--vi-badge-font-size, var(--vi-font-size-xs, .75rem));font-weight:var(--vi-badge-font-weight, var(--vi-font-weight-semibold, 600));padding:var(--vi-badge-padding, 0 var(--vi-spacing-xs, .5rem));border-radius:var(--vi-badge-border-radius, var(--vi-border-radius-full, 9999px));gap:var(--vi-badge-gap, var(--vi-spacing-unit, .25rem));border:var(--vi-border-width-thin, 1px) solid transparent}.dot{display:inline-block;width:var(--vi-badge-dot-size, var(--vi-spacing-xs, .5rem));height:var(--vi-badge-dot-size, var(--vi-spacing-xs, .5rem));border-radius:50%;background-color:currentColor;flex-shrink:0}.icon{display:inline-flex;align-items:center;justify-content:center;flex-shrink:0}}:host{display:inline-block;vertical-align:middle}:host([hidden]),:host([count=\"0\"]:not([show-zero])){display:none!important}:host([size=sm]) .badge{font-size:var(--vi-badge-font-size, var(--vi-font-size-xs, .75rem));padding:var(--vi-badge-padding, 0 var(--vi-spacing-unit, .25rem));gap:var(--vi-badge-gap, var(--vi-spacing-unit, .25rem))}:host([size=md]) .badge{height:var(--vi-badge-height, 1.25rem);font-size:var(--vi-badge-font-size, var(--vi-font-size-xs, .75rem));padding:var(--vi-badge-padding, 0 var(--vi-spacing-xs, .5rem));gap:var(--vi-badge-gap, var(--vi-spacing-unit, .25rem))}:host([size=lg]) .badge{font-size:var(--vi-badge-font-size, var(--vi-font-size-base, .875rem));padding:var(--vi-badge-padding, var(--vi-spacing-unit, .25rem) var(--vi-spacing-sm, .75rem));gap:var(--vi-badge-gap, var(--vi-spacing-xs, .5rem))}:host([pill]) .badge{border-radius:var(--vi-badge-border-radius, var(--vi-border-radius-full, 9999px))}:host(:not([pill])) .badge{border-radius:var(--vi-badge-border-radius, var(--vi-border-radius-sm, 4px))}.badge.dot-only{--vi-badge-padding: var(--vi-spacing-unit, .25rem)}:host([variant=neutral]) .badge{background-color:var(--vi-badge-neutral-bg, var(--vi-border-02, #eeeeee));color:var(--vi-badge-neutral-color, var(--vi-text-secondary, #4b5563))}:host([variant=primary]) .badge{background-color:var(--vi-badge-primary-bg, var(--vi-bg-info, #e3f2fd));color:var(--vi-badge-primary-color, var(--vi-text-info, #3676d0))}:host([variant=success]) .badge{background-color:var(--vi-badge-success-bg, var(--vi-bg-success, #e6f9f0));color:var(--vi-badge-success-color, var(--vi-text-success, #265a3d))}:host([variant=warning]) .badge{background-color:var(--vi-badge-warning-bg, var(--vi-bg-warning, #fff8e1));color:var(--vi-badge-warning-color, var(--vi-text-warning, #e68300))}:host([variant=danger]) .badge{background-color:var(--vi-badge-danger-bg, var(--vi-bg-error, #ffebee));color:var(--vi-badge-danger-color, var(--vi-text-error, #db231b))}:host([variant=info]) .badge{background-color:var(--vi-badge-info-bg, var(--vi-bg-info, #e3f2fd));color:var(--vi-badge-info-color, var(--vi-text-info, #3676d0))}:host([outline][variant=neutral]) .badge{background-color:transparent;color:var(--vi-badge-neutral-color, var(--vi-text-secondary, #4b5563));border-color:var(--vi-badge-neutral-border, var(--vi-border-03, #e0e0e0))}:host([outline][variant=primary]) .badge{background-color:transparent;color:var(--vi-badge-primary-color, var(--vi-text-info, #3676d0));border-color:var(--vi-badge-primary-border, var(--vi-color-primary, #3676d0))}:host([outline][variant=success]) .badge{background-color:transparent;color:var(--vi-badge-success-color, var(--vi-text-success, #265a3d));border-color:var(--vi-badge-success-border, var(--vi-color-success, #489167))}:host([outline][variant=warning]) .badge{background-color:transparent;color:var(--vi-badge-warning-color, var(--vi-text-warning, #e68300));border-color:var(--vi-badge-warning-border, var(--vi-color-warning, #ffba00))}:host([outline][variant=danger]) .badge{background-color:transparent;color:var(--vi-badge-danger-color, var(--vi-text-error, #db231b));border-color:var(--vi-badge-danger-border, var(--vi-color-error, #ef4444))}:host([outline][variant=info]) .badge{background-color:transparent;color:var(--vi-badge-info-color, var(--vi-text-info, #3676d0));border-color:var(--vi-badge-info-border, var(--vi-color-info, #3676d0))}.icon{display:inline-flex;flex-shrink:0}.icon[hidden]{display:none}::slotted(vi-icon),::slotted(svg){--vi-icon-size: 1em;width:1em;height:1em}";
