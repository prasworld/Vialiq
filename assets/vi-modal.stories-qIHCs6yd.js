import { b, r as r$1, i, A, c as i$1 } from './iframe-CsJj_TMi.js';
import { o } from './if-defined-Biv9U5FK.js';
import { n, t, V as ViElement } from './vi-element-x0MuQYw0.js';
import { r } from './state-CH4t8y76.js';
import { O as OverlayManager, e as e$2 } from './overlay-manager-B43cq-OI.js';
import { e as e$1 } from './class-map-tncBcIr8.js';
import './vi-icon-uHrW9gxw.js';
import './vi-button-Cv2Xx4o7.js';
...
const modalStyles = "@charset \"UTF-8\";@layer reset,components,utilities;@layer components{.modal-dialog,[part=dialog]{border:none;color:inherit;display:none;background-color:var(--vi-modal-bg, var(--vi-color-background, #ffffff));border-radius:var(--vi-modal-border-radius, var(--vi-border-radius-lg, 8px));box-shadow:var(--vi-modal-shadow, var(--vi-shadow-xl, 0 20px 25px -5px rgba(0, 0, 0, .1)));padding:0;margin:auto;width:100%;max-width:var(--vi-modal-max-width-md, 640px);max-height:90vh;z-index:var(--vi-modal-z-index, 1050);font-family:var(--vi-font-family-base, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif);font-size:var(--vi-font-size-base, 16px);line-height:var(--vi-line-height-normal, 1.5);color:var(--vi-text-primary, #111827)}.modal-dialog[open],[open][part=dialog]{display:flex;flex-direction:column;animation:vi-modal-enter var(--vi-modal-animation-duration, .2s) ease-out}.modal-dialog::backdrop,[part=dialog]::backdrop{background-color:var(--vi-modal-backdrop-bg, rgba(0, 0, 0, .5))}.modal-header,[part=header]{display:flex;align-items:center;justify-content:space-between;padding:var(--vi-modal-header-padding, 20px 24px);flex-shrink:0}.modal-dialog.is-draggable .modal-header,.is-draggable[part=dialog] .modal-header,.modal-dialog.is-draggable [part=header],.is-draggable[part=dialog] [part=header]{cursor:move;-webkit-user-select:none;user-select:none}.modal-title,[part=title]{font-size:var(--vi-font-size-lg, 18px);font-weight:var(--vi-font-weight-semibold, 600);margin:0}.modal-header-actions{display:flex;align-items:center;gap:var(--vi-spacing-xs, 8px)}.modal-body,[part=body]{padding:var(--vi-modal-body-padding, 24px);flex-grow:1;overflow-y:auto}.modal-footer,[part=footer]{display:flex;align-items:center;justify-content:flex-end;gap:var(--vi-spacing-sm, 16px);padding:var(--vi-modal-footer-padding, 16px 24px);background-color:var(--vi-modal-footer-bg, var(--vi-layer-02, #f3f4f6));border-top:1px solid var(--vi-modal-footer-border-color, var(--vi-border-02, #eeeeee));flex-shrink:0}.modal-variant-drawer{margin:0;max-height:none;height:100vh;height:100dvh;max-width:none;width:var(--vi-modal-drawer-width, 480px);border-radius:0}.modal-variant-drawer.placement-right{margin-left:auto}.modal-variant-drawer.placement-right[open]{animation:vi-modal-drawer-enter-right var(--vi-modal-animation-duration, .2s) ease-out}.modal-variant-drawer.placement-left{margin-right:auto}.modal-variant-drawer.placement-left[open]{animation:vi-modal-drawer-enter-left var(--vi-modal-animation-duration, .2s) ease-out}.modal-variant-alert{flex-direction:row;padding:var(--vi-modal-body-padding, 24px);max-width:var(--vi-modal-max-width-sm, 480px)}.modal-variant-alert .modal-alert-icon{flex-shrink:0;margin-right:var(--vi-spacing-md, 24px);display:flex;align-items:flex-start;padding-top:2px}.modal-variant-alert .modal-alert-content{flex-grow:1;display:flex;flex-direction:column}.modal-variant-alert .modal-alert-content .modal-header,.modal-variant-alert .modal-alert-content [part=header]{padding:0;margin-bottom:var(--vi-spacing-xs, 8px)}.modal-variant-alert .modal-alert-content .modal-body,.modal-variant-alert .modal-alert-content [part=body]{padding:0;margin-bottom:var(--vi-spacing-sm, 16px)}.modal-variant-alert .modal-alert-content .modal-footer,.modal-variant-alert .modal-alert-content [part=footer]{padding:0;background:transparent;border-top:none;margin-top:auto}.modal-variant-alert[open]{animation:vi-modal-alert-enter var(--vi-modal-animation-duration, .2s) cubic-bezier(.175,.885,.32,1.275)}.modal-size-xs{max-width:var(--vi-modal-max-width-xs, 320px)}.modal-size-sm{max-width:var(--vi-modal-max-width-sm, 480px)}.modal-size-md{max-width:var(--vi-modal-max-width-md, 640px)}.modal-size-lg{max-width:var(--vi-modal-max-width-lg, 800px)}.modal-size-xl{max-width:var(--vi-modal-max-width-xl, 960px)}.modal-size-fullscreen{max-width:none;width:100vw;width:100dvw;max-height:none;height:100vh;height:100dvh;border-radius:0;margin:0}.modal-size-full-width{max-width:none;width:100vw;width:100dvw;border-radius:0;margin-left:0;margin-right:0}.modal-scrollable-false .modal-body,.modal-scrollable-false [part=body]{overflow-y:visible}@keyframes vi-modal-enter{0%{opacity:0;transform:scale(.96)}to{opacity:1;transform:scale(1)}}@keyframes vi-modal-drawer-enter-right{0%{transform:translate(100%)}to{transform:translate(0)}}@keyframes vi-modal-drawer-enter-left{0%{transform:translate(-100%)}to{transform:translate(0)}}@keyframes vi-modal-alert-enter{0%{opacity:0;transform:scale(.8)}to{opacity:1;transform:scale(1)}}@media(prefers-reduced-motion:reduce){.modal-dialog[open],[open][part=dialog]{animation:none!important}}@media(max-width:639px){.modal-dialog:not(.modal-variant-drawer),[part=dialog]:not(.modal-variant-drawer){max-width:100vw!important;width:100vw!important;width:100dvw!important;max-height:100vh!important;height:100vh!important;height:100dvh!important;border-radius:0!important;margin:0!important;transform:none!important}.modal-header,[part=header],.modal-body,[part=body],.modal-footer,[part=footer]{padding:var(--vi-spacing-md, 24px)}}}:host{display:block}:host(:not([open])){display:none}.modal-backdrop{position:fixed;inset:0;background:var(--vi-modal-backdrop-bg, var(--vi-modal-backdrop-bg, rgba(0, 0, 0, .5)));-webkit-backdrop-filter:blur(2px);backdrop-filter:blur(2px);pointer-events:auto}[part=dialog][open]{position:fixed;inset:0;margin:auto}[part=dialog].modal-variant-drawer{margin:0}[part=dialog].modal-variant-drawer.placement-right{margin-left:auto}[part=dialog].modal-variant-drawer.placement-left{margin-right:auto}[part=dialog].modal-position-top{margin-top:var(--vi-modal-offset-y, 5vh);margin-bottom:auto}[part=dialog].modal-position-bottom{margin-top:auto;margin-bottom:var(--vi-modal-offset-y, 5vh)}[part=dialog].modal-position-left{margin-left:var(--vi-modal-offset-x, 5vw);margin-right:auto}[part=dialog].modal-position-right{margin-left:auto;margin-right:var(--vi-modal-offset-x, 5vw)}[part=dialog].modal-position-top-left{margin:var(--vi-modal-offset-y, 5vh) auto auto var(--vi-modal-offset-x, 5vw)}[part=dialog].modal-position-top-right{margin:var(--vi-modal-offset-y, 5vh) var(--vi-modal-offset-x, 5vw) auto auto}[part=dialog].modal-position-bottom-left{margin:auto auto var(--vi-modal-offset-y, 5vh) var(--vi-modal-offset-x, 5vw)}[part=dialog].modal-position-bottom-right{margin:auto var(--vi-modal-offset-x, 5vw) var(--vi-modal-offset-y, 5vh) auto}.is-maximized{margin:0!important;max-width:100vw!important;max-height:100vh!important;width:100vw!important;height:100vh!important;border-radius:0!important;transform:none!important}.resize-handle{position:absolute;z-index:10}.resize-handle-n{top:-4px;left:8px;right:8px;height:8px;cursor:n-resize}.resize-handle-s{bottom:-4px;left:8px;right:8px;height:8px;cursor:s-resize}.resize-handle-e{right:-4px;top:8px;bottom:8px;width:8px;cursor:e-resize}.resize-handle-w{left:-4px;top:8px;bottom:8px;width:8px;cursor:w-resize}.resize-handle-ne{top:-4px;right:-4px;width:12px;height:12px;cursor:ne-resize}.resize-handle-nw{top:-4px;left:-4px;width:12px;height:12px;cursor:nw-resize}.resize-handle-se{bottom:-4px;right:-4px;width:12px;height:12px;cursor:se-resize}.resize-handle-sw{bottom:-4px;left:-4px;width:12px;height:12px;cursor:sw-resize}.is-maximized .resize-handle{display:none}.is-draggable [part=header],.is-draggable .modal-header{cursor:grab!important}.is-draggable [part=header]:active,.is-draggable .modal-header:active{cursor:grabbing!important}[part=dialog].modal-variant-alert{padding:0!important;flex-direction:column!important}.modal-header--alert{display:flex;align-items:center;justify-content:flex-start;gap:var(--vi-spacing-sm, 12px)}.modal-header--alert .modal-alert-icon{display:flex;margin:0;padding:0}:host([alert-variant=danger]) .modal-alert-icon{color:var(--vi-color-error, #ef4444)}:host([alert-variant=warning]) .modal-alert-icon{color:var(--vi-color-warning, #ffba00)}:host([alert-variant=success]) .modal-alert-icon{color:var(--vi-color-success, #489167)}:host([alert-variant=info]) .modal-alert-icon,:host(:not([alert-variant])) .modal-alert-icon{color:var(--vi-color-info, #3676d0)}";
...
const styles$1 = "@charset \"UTF-8\";@layer reset,components,utilities;@layer components{.modal-dialog{border:none;color:inherit;display:none;background-color:var(--vi-modal-bg, var(--vi-color-background, #ffffff));border-radius:var(--vi-modal-border-radius, var(--vi-border-radius-lg, 8px));box-shadow:var(--vi-modal-shadow, var(--vi-shadow-xl, 0 20px 25px -5px rgba(0, 0, 0, .1)));padding:0;margin:auto;width:100%;max-width:var(--vi-modal-max-width-md, 640px);max-height:90vh;z-index:var(--vi-modal-z-index, 1050);font-family:var(--vi-font-family-base, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif);font-size:var(--vi-font-size-base, 16px);line-height:var(--vi-line-height-normal, 1.5);color:var(--vi-text-primary, #111827)}.modal-dialog[open]{display:flex;flex-direction:column;animation:vi-modal-enter var(--vi-modal-animation-duration, .2s) ease-out}.modal-dialog::backdrop{background-color:var(--vi-modal-backdrop-bg, rgba(0, 0, 0, .5))}.modal-header{display:flex;align-items:center;justify-content:space-between;padding:var(--vi-modal-header-padding, 20px 24px);flex-shrink:0}.modal-dialog.is-draggable .modal-header{cursor:move;-webkit-user-select:none;user-select:none}.modal-title{font-size:var(--vi-font-size-lg, 18px);font-weight:var(--vi-font-weight-semibold, 600);margin:0}.modal-header-actions{display:flex;align-items:center;gap:var(--vi-spacing-xs, 8px)}.modal-body{padding:var(--vi-modal-body-padding, 24px);flex-grow:1;overflow-y:auto}.modal-footer{display:flex;align-items:center;justify-content:flex-end;gap:var(--vi-spacing-sm, 16px);padding:var(--vi-modal-footer-padding, 16px 24px);background-color:var(--vi-modal-footer-bg, var(--vi-layer-02, #f3f4f6));border-top:1px solid var(--vi-modal-footer-border-color, var(--vi-border-02, #eeeeee));flex-shrink:0}.modal-variant-drawer{margin:0;max-height:none;height:100vh;height:100dvh;max-width:none;width:var(--vi-modal-drawer-width, 480px);border-radius:0}.modal-variant-drawer.placement-right{margin-left:auto}.modal-variant-drawer.placement-right[open]{animation:vi-modal-drawer-enter-right var(--vi-modal-animation-duration, .2s) ease-out}.modal-variant-drawer.placement-left{margin-right:auto}.modal-variant-drawer.placement-left[open]{animation:vi-modal-drawer-enter-left var(--vi-modal-animation-duration, .2s) ease-out}.modal-variant-alert{flex-direction:row;padding:var(--vi-modal-body-padding, 24px);max-width:var(--vi-modal-max-width-sm, 480px)}.modal-variant-alert .modal-alert-icon{flex-shrink:0;margin-right:var(--vi-spacing-md, 24px);display:flex;align-items:flex-start;padding-top:2px}.modal-variant-alert .modal-alert-content{flex-grow:1;display:flex;flex-direction:column}.modal-variant-alert .modal-alert-content .modal-header{padding:0;margin-bottom:var(--vi-spacing-xs, 8px)}.modal-variant-alert .modal-alert-content .modal-body{padding:0;margin-bottom:var(--vi-spacing-sm, 16px)}.modal-variant-alert .modal-alert-content .modal-footer{padding:0;background:transparent;border-top:none;margin-top:auto}.modal-variant-alert[open]{animation:vi-modal-alert-enter var(--vi-modal-animation-duration, .2s) cubic-bezier(.175,.885,.32,1.275)}.modal-size-xs{max-width:var(--vi-modal-max-width-xs, 320px)}.modal-size-sm{max-width:var(--vi-modal-max-width-sm, 480px)}.modal-size-md{max-width:var(--vi-modal-max-width-md, 640px)}.modal-size-lg{max-width:var(--vi-modal-max-width-lg, 800px)}.modal-size-xl{max-width:var(--vi-modal-max-width-xl, 960px)}.modal-size-fullscreen{max-width:none;width:100vw;width:100dvw;max-height:none;height:100vh;height:100dvh;border-radius:0;margin:0}.modal-size-full-width{max-width:none;width:100vw;width:100dvw;border-radius:0;margin-left:0;margin-right:0}.modal-scrollable-false .modal-body{overflow-y:visible}@keyframes vi-modal-enter{0%{opacity:0;transform:scale(.96)}to{opacity:1;transform:scale(1)}}@keyframes vi-modal-drawer-enter-right{0%{transform:translate(100%)}to{transform:translate(0)}}@keyframes vi-modal-drawer-enter-left{0%{transform:translate(-100%)}to{transform:translate(0)}}@keyframes vi-modal-alert-enter{0%{opacity:0;transform:scale(.8)}to{opacity:1;transform:scale(1)}}@media(prefers-reduced-motion:reduce){.modal-dialog[open]{animation:none!important}}@media(max-width:639px){.modal-dialog:not(.modal-variant-drawer){max-width:100vw!important;width:100vw!important;width:100dvw!important;max-height:100vh!important;height:100vh!important;height:100dvh!important;border-radius:0!important;margin:0!important;transform:none!important}.modal-header,.modal-body,.modal-footer{padding:var(--vi-spacing-md, 24px)}}}:host{display:block}.modal-description{margin:var(--vi-spacing-xs, 8px) 0 0 0;font-size:var(--vi-font-size-sm, 14px);color:var(--vi-text-secondary, #4b5563);font-weight:var(--vi-font-weight-normal, 400)}.modal-header-content{flex-grow:1;display:flex;flex-direction:column}.modal-header--alert{display:flex;align-items:center;justify-content:flex-start;gap:var(--vi-spacing-sm, 12px)}.modal-header--alert .modal-alert-icon{display:flex;align-items:center;justify-content:center;margin:0;padding:0;width:var(--vi-icon-size-md, 24px);height:var(--vi-icon-size-md, 24px);font-size:var(--vi-icon-size-md, 24px)}:host([alert-variant=danger]) .modal-alert-icon{color:var(--vi-color-error, #ef4444)}:host([alert-variant=warning]) .modal-alert-icon{color:var(--vi-color-warning, #ffba00)}:host([alert-variant=success]) .modal-alert-icon{color:var(--vi-color-success, #489167)}:host([alert-variant=info]) .modal-alert-icon,:host(:not([alert-variant])) .modal-alert-icon{color:var(--vi-color-info, #3676d0)}";
...
const styles = "@charset \"UTF-8\";@layer reset,components,utilities;@layer components{.modal-dialog{border:none;color:inherit;display:none;background-color:var(--vi-modal-bg, var(--vi-color-background, #ffffff));border-radius:var(--vi-modal-border-radius, var(--vi-border-radius-lg, 8px));box-shadow:var(--vi-modal-shadow, var(--vi-shadow-xl, 0 20px 25px -5px rgba(0, 0, 0, .1)));padding:0;margin:auto;width:100%;max-width:var(--vi-modal-max-width-md, 640px);max-height:90vh;z-index:var(--vi-modal-z-index, 1050);font-family:var(--vi-font-family-base, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif);font-size:var(--vi-font-size-base, 16px);line-height:var(--vi-line-height-normal, 1.5);color:var(--vi-text-primary, #111827)}.modal-dialog[open]{display:flex;flex-direction:column;animation:vi-modal-enter var(--vi-modal-animation-duration, .2s) ease-out}.modal-dialog::backdrop{background-color:var(--vi-modal-backdrop-bg, rgba(0, 0, 0, .5))}.modal-header{display:flex;align-items:center;justify-content:space-between;padding:var(--vi-modal-header-padding, 20px 24px);flex-shrink:0}.modal-dialog.is-draggable .modal-header{cursor:move;-webkit-user-select:none;user-select:none}.modal-title{font-size:var(--vi-font-size-lg, 18px);font-weight:var(--vi-font-weight-semibold, 600);margin:0}.modal-header-actions{display:flex;align-items:center;gap:var(--vi-spacing-xs, 8px)}.modal-body{padding:var(--vi-modal-body-padding, 24px);flex-grow:1;overflow-y:auto}.modal-footer{display:flex;align-items:center;justify-content:flex-end;gap:var(--vi-spacing-sm, 16px);padding:var(--vi-modal-footer-padding, 16px 24px);background-color:var(--vi-modal-footer-bg, var(--vi-layer-02, #f3f4f6));border-top:1px solid var(--vi-modal-footer-border-color, var(--vi-border-02, #eeeeee));flex-shrink:0}.modal-variant-drawer{margin:0;max-height:none;height:100vh;height:100dvh;max-width:none;width:var(--vi-modal-drawer-width, 480px);border-radius:0}.modal-variant-drawer.placement-right{margin-left:auto}.modal-variant-drawer.placement-right[open]{animation:vi-modal-drawer-enter-right var(--vi-modal-animation-duration, .2s) ease-out}.modal-variant-drawer.placement-left{margin-right:auto}.modal-variant-drawer.placement-left[open]{animation:vi-modal-drawer-enter-left var(--vi-modal-animation-duration, .2s) ease-out}.modal-variant-alert{flex-direction:row;padding:var(--vi-modal-body-padding, 24px);max-width:var(--vi-modal-max-width-sm, 480px)}.modal-variant-alert .modal-alert-icon{flex-shrink:0;margin-right:var(--vi-spacing-md, 24px);display:flex;align-items:flex-start;padding-top:2px}.modal-variant-alert .modal-alert-content{flex-grow:1;display:flex;flex-direction:column}.modal-variant-alert .modal-alert-content .modal-header{padding:0;margin-bottom:var(--vi-spacing-xs, 8px)}.modal-variant-alert .modal-alert-content .modal-body{padding:0;margin-bottom:var(--vi-spacing-sm, 16px)}.modal-variant-alert .modal-alert-content .modal-footer{padding:0;background:transparent;border-top:none;margin-top:auto}.modal-variant-alert[open]{animation:vi-modal-alert-enter var(--vi-modal-animation-duration, .2s) cubic-bezier(.175,.885,.32,1.275)}.modal-size-xs{max-width:var(--vi-modal-max-width-xs, 320px)}.modal-size-sm{max-width:var(--vi-modal-max-width-sm, 480px)}.modal-size-md{max-width:var(--vi-modal-max-width-md, 640px)}.modal-size-lg{max-width:var(--vi-modal-max-width-lg, 800px)}.modal-size-xl{max-width:var(--vi-modal-max-width-xl, 960px)}.modal-size-fullscreen{max-width:none;width:100vw;width:100dvw;max-height:none;height:100vh;height:100dvh;border-radius:0;margin:0}.modal-size-full-width{max-width:none;width:100vw;width:100dvw;border-radius:0;margin-left:0;margin-right:0}.modal-scrollable-false .modal-body{overflow-y:visible}@keyframes vi-modal-enter{0%{opacity:0;transform:scale(.96)}to{opacity:1;transform:scale(1)}}@keyframes vi-modal-drawer-enter-right{0%{transform:translate(100%)}to{transform:translate(0)}}@keyframes vi-modal-drawer-enter-left{0%{transform:translate(-100%)}to{transform:translate(0)}}@keyframes vi-modal-alert-enter{0%{opacity:0;transform:scale(.8)}to{opacity:1;transform:scale(1)}}@media(prefers-reduced-motion:reduce){.modal-dialog[open]{animation:none!important}}@media(max-width:639px){.modal-dialog:not(.modal-variant-drawer){max-width:100vw!important;width:100vw!important;width:100dvw!important;max-height:100vh!important;height:100vh!important;height:100dvh!important;border-radius:0!important;margin:0!important;transform:none!important}.modal-header,.modal-body,.modal-footer{padding:var(--vi-spacing-md, 24px)}}}:host{display:block;width:100%;flex-shrink:0}";
...
const EventLifecycle = {
    render: (args)=>{
        ...
        const handleRequestClose = (e1)=>{
            logEvent('vi-modal-request-close', e1.detail);
        };
